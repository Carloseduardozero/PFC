...
<html>
        ...
        <label id="icone" for="check"><img src="../img/icone.png"></label>
                    <nav>
                        <ul> 
                            ...
                            <li><a href="lista de Materiais.php"><div class="link"><img src="../img/mat.png" width="38px" height="38px">  Materiais e Normas</div></a></li>
    ...
    <div class="fundinho">
        <c href=""> <img src="./../img/new1.png" width="200px" height="200px"></c>
        <d href=""> <img src="./../img/new1.png" width="200px" height="200px"></d>
        <e href=""> <img src="./../img/new1.png" width="200px" height="200px"></e>
        <br>
        <f href=""> <img src="./../img/new1.png" width="200px" height="200px"></f>
        <g href=""> <img src="./../img/new1.png" width="200px" height="200px"></g>
        <h href=""> <img src="./../img/new1.png" width="200px" height="200px"></h>
    </div>
    <center>
    <div class="barraZ">
