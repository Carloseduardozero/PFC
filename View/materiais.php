...
<html>
    ...
    <div class="fundao">
        <div class="mat">
        <l href="Inicio.php"><img src="./../img/pipes.png" width="150px" height="200px">TUBULAÇÕES</l>
        <m href="Inicio.php"><img src="./../img/document.png" width="150px" height="160px">NORMAS</m>
        </div>
    </div>  
    <center>
    <div class="barraZ">
